...
from visions.backends.numpy_.types.integer import float_is_integer, float_to_integer, integer_contains


def test_sequences():
    assert (float_to_integer(np.array([1.0, 2.0, 3.0]), {}) == np.array([1, 2, 3])).all()
