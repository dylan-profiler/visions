...
from tenzing.core.model.types import tenzing_integer, tenzing_existing_path, missing_generic
...
summary.plot(summaries_dir / 'summary_integer_missing.svg', tenzing_integer + missing_generic)
