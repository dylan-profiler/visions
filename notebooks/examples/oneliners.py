...
from tenzing.core.model.types import tenzing_bool, tenzing_generic, tenzing_integer, missing_generic, tenzing_object
...
print(pd.Series([0, 1, 2, 3], dtype="Int64") in tenzing_integer + missing_generic) # True
