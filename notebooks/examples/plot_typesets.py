...
from tenzing.core.model.typesets import tenzing_complete_set, tenzing_standard_set, tenzing_geometry_set
...
# Initialize typeset
for name, tsc in [('typeset_complete', tenzing_complete_set()), ('typeset_geometry', tenzing_geometry_set()), ('typeset_standard', tenzing_standard_set())]:
    # Write graph to dot
