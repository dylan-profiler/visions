...
type_summary_ops = {
    ...
    tenzing_complex: [complex_summary],
    tenzing_datetime: [datetime_summary, unique_summary],
    tenzing_date: [],
    tenzing_existing_path: [existing_path_summary, path_summary, string_summary],
    tenzing_float: [numerical_summary, zero_summary],
    tenzing_geometry: [],
    tenzing_image_path: [],
    tenzing_integer: [numerical_summary, zero_summary],
    tenzing_object: [],
    tenzing_path: [path_summary, string_summary],
    tenzing_string: [string_summary],
    tenzing_time: [],
    tenzing_timedelta: [],
