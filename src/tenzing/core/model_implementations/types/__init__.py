...
from tenzing.core.model_implementations.types.tenzing_image_path import (
    tenzing_image_path,
)
...
from tenzing.core.model_implementations.types.tenzing_empty import tenzing_empty
